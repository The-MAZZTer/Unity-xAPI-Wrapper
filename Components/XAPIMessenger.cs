...
namespace XAPI {
  public class XAPIMessenger : MonoBehaviour {
    ...
    private static UnityWebRequest BuildPostRequest(string url, string payload) {
      ...
      request.SetRequestHeader("Content-Type", "application/json");
			...
			if (Config.IgnoreCertificateErrors) {
				request.certificateHandler = ignoreCerts;
    ...
    private static IgnoreCertificateHandler ignoreCerts = new();
		private class IgnoreCertificateHandler : CertificateHandler {
